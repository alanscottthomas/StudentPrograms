...
Assignment: Feistel Cipher Second Version Implementation | Assignment#7
Professor: Dr. Dutta
Date: 2/19/18
Notes: No notes.
*/
...
int main()
{
    ...
    string sentence;
    char *ptr;
    int *ptr1, *ptr2, *ptr3, counter=8, counter2=0, counter3=0,counter4=0, counter5=0, randnum,code=1;
...
cout<<"--BINARY VALUES BEFORE ENCRYPTION--"<<endl;
//read ptr2 array
...
cout<<endl<<"--PRESS ENTER TO EXECUTE ENCRYPTION--"<<endl;
cin.get();
        ...
        if (code%2==1)
        {
            ...
            counter4++;
                ...
                if(counter4 % 12==0)
                {
                    for(int j=0;j<12;j++)
                    {
                        leftside[j]=leftside[j] * key1[j]; //XORing
                    }
				counter4=0;
				code++;
				}
...
cout<<"--BINARY VALUES AFTER ENCRYPTION--"<<endl;
//read ptr2 array
    for(int i=0;i<length*8;i++)
        {
            if(i%8==0)

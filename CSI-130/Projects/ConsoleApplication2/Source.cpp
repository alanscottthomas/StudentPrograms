...
int main()
{
	int acc[5] = { 0 }, ir[8] = { 0 }, pc = 0, mdr[8] = { 0 }, mar[8] = { 0 },
		ram[256][8] = { { 0 } }, opcode, operand = 0, i = 0, j = 0,
	...
	cout << "--Below are your options for the central processor simulator--" << endl<<endl;
	...
	cout << "Enter a '7' to JMPNE" << endl << endl << endl << "Enter OPCODE: ";
	...
	while (opcode != 0)
	{
		...
		cout << "Enter a '5' to ADD" << endl;
		cout << "Enter a '6' to COMPARE" << endl;
		cout << "Enter a '7' to JMPNE" << endl << endl << endl;
		cout << "Enter OPCODE: ";
		//Getting opcode from user
		cin >> opcode;
		sop = opcode;

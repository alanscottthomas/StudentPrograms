...
void Symbol::add_symbol(vector<TABLE>& symbols)
{
...
void Symbol::print_symbol(vector<TABLE>& symbols)
{
...
void Symbol::print_scope(vector<TABLE>& symbols)
{
	const char seperator = ' ';                                                                      //variable used for tabular printing
	const int nameWidth = 13;                                                                        //variable used for tabular printing
	const int numWidth = 20;                                                                         //variable used for tabular printing
...
void Symbol::check_id_scope(vector<TABLE>& symbols)
{
	const char seperator = ' ';                                                                              //variable used for tabular printing
	const int nameWidth = 13;                                                                                //variable used for tabular printing
	const int numWidth = 20;                                                                                 //variable used for tabular printing
...
void Symbol::check_id_table(vector<TABLE>& symbols)
{
...
//EXAMINE ATTRIBUTES//
void Symbol::look_at_attrib(vector<TABLE>& symbols)
{
	const char seperator = ' ';                                                                      //variable to use for tabulated printing
	const int nameWidth = 13;                                                                        //variable to use for tabulated printing
	const int numWidth = 20;                                                                         //variable to use for tabulated printing
...
//DELETE ID IN TABLE//
void Symbol::delete_id_table(vector<TABLE>& symbols)
{

...
//assign/get variable values to/from session data//
$id = $_SESSION["id"];
$_SESSION["id"] = $id;
...
//get health info//
$sql3 = "SELECT * FROM `user_tbl` WHERE `user_id` = ".$id.";";                //get user info from user table
$result3 = $conn2->query($sql3) or trigger_error($conn2->error."[$sql3]");    //saving user data to results
//place data into rows//
...
//---------//
	...
	//display text alerting user that they found a sword//
	echo "<enemy_info>";
	$damage = rand(10,30);
...
//----------------//
 	...
 	$sql2 = "UPDATE user_tbl SET sword = '2' WHERE user_tbl.user_id = '$id';";  //set user data to have a sword
	mysqli_query($conn2, $sql2);  //execute SQL statement
	
	echo nl2br("<br>");
	echo nl2br("<br>");
	
//if statements for sword image//
	echo "<img src='sword.png' height='400' width='1017'>";        //change to image of a sword
//-------------------------------//

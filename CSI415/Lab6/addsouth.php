<html>
	...
	<title>South room connected</title>
	...
	if(isset($_POST['submit'])){
	    ...
	    if(empty($_POST['level_name'])){
	        ...
	        $level_name = trim($_POST['level_name']);
                $south_room = trim($_POST['south_room']);
...
//echo $room_id;
	       ...
	       $query = "UPDATE rooms_tbl SET south = ? WHERE room_id= ?";
	        ...
	        mysqli_stmt_bind_param($stmt,'si',$south,$room_id);

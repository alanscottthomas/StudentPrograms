<html>
	...
	<title>East room connected</title>
	...
	if(isset($_POST['submit'])){
	    ...
	    if(empty($_POST['level_name'])){
	        ...
	        $level_name = trim($_POST['level_name']);
                $east_room = trim($_POST['east_room']);
...
//echo $room_id;
	       ...
	       $query = "UPDATE rooms_tbl SET east = ? WHERE room_id= ?";
	        ...
	        mysqli_stmt_bind_param($stmt,'si',$east,$room_id);

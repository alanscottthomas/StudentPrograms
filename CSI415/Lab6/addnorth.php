<html>
	...
	<title>North room connected</title>
	...
	if(isset($_POST['submit'])){
	    ...
	    if(empty($_POST['level_name'])){
	        ...
	        $level_name = trim($_POST['level_name']);
                $north_room = trim($_POST['north_room']);
...
//echo $room_id;
	       ...
	       $query = "UPDATE rooms_tbl SET north = ? WHERE room_id= ?";
	        ...
	        mysqli_stmt_bind_param($stmt,'si',$north,$room_id);
